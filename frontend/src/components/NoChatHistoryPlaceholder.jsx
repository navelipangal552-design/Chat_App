...
//UI screen displayed when the user opens a chat with someone for the first time and there are no previous messages.
/*
It shows:
an icon
a friendly heading
a short description
a separator line
a few quick-start message suggestions */
